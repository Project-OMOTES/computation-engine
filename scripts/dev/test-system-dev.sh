...
ENV_FILE=".env.test"
DOCKER_COMPOSE="docker compose -f docker-compose.yml -f docker-compose.override.dev.yml -f system_tests/docker-compose.override.yml -f system_tests/docker-compose.override.dev.yml --env-file ${ENV_FILE} --profile deploy-optimizer --profile deploy-simulator"
